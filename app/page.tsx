...
export default function Home() {
  ...
  return <main>
    ...
    <section className="section know-me" aria-labelledby="know-title"><div className="know-heading"><p className="eyebrow">03 / A little more</p><h2 id="know-title" className="statement">A love of beautiful things evolved into a passion for creating useful, thoughtful products beyond decoration.</h2><a className="soft-button" href="/about/">More about me</a></div><div className="know-content"><div className="clusters"><div><p className="eyebrow">Core Strengths</p><ul><li>Product Design</li><li>UX Design</li><li>UI Design</li><li>UX Copywriting</li><li>Design System</li><li>UX Research</li><li>Information Architecture</li><li>Design with AI</li></ul><p className="eyebrow tools-label">Tools</p><ul className="tools-list"><li>Figma</li><li>Adobe Creative Suite</li><li>Claude</li><li>Codex</li><li>Maze</li></ul></div></div></div></section>
