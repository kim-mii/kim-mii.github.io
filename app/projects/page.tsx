...
export default function Projects() {
  ...
  return <main className="work-page">
    ...
    <SiteHeader />
    <section className="work-intro"><p className="eyebrow">{t('work.selected', 'Selected work')}</p><h1 className={language === 'zh' ? 'zh-display' : undefined}>{language === 'zh' ? <>這些，是我<span className="zh-pink-highlight">親手</span>做出來的。</> : <>A closer look at what I’ve <i>shaped.</i></>}</h1><p>{t('work.intro', 'A selection of work across product, UI/UX, branding, packaging, and digital experiences.')}</p></section>
